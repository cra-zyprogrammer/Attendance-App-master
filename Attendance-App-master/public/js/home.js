...
function copyMeet() {
  let username=document.getElementById('user_name_meet').value;
  let password=document.getElementById('pass_word_meet').value;
  copyCode(`let c="";let dateMeet="";dateMeet+=new Date().toLocaleString("en-US");document.querySelectorAll('[class^="VfPpkd-Bz112c-LgbsSe yHy1rc eT1oJ JsuyRc boDUxc"]')[1].click();
